...
class QuoteMachine extends React.Component {
  ...
  render() {
    ...
    return (
      <div id="quote-box">
        <p id="text">{chosenQuote.quote}</p>
        <p id="author">{chosenQuote.author}</p>
        <button className="button" id="new-quote" onClick={this.generate}>
          New Quote
        </button>
        <a href="twitter.com/intent/tweet" id="tweet-quote" title="Share to Twitter"><i class="fa fa-twitter fa-2x"></i></a></div>
    );
  }
}
